...
d.box("d1",  "dec",   "重みの合計\n&gt; 0 ?", 370, 650, 220, 84)
d.box("r1",  "prior", "全滅リカバリ\n直前位置の周囲へ再配置し\n重みを一様に戻す", 80, 652, 230, 64)
d.box("r1n", "orig",  "全滅回数を記録\n(評価指標 6.6節)", 80, 745, 230, 48)
d.box("d2",  "dec",   "Neff &lt; N / 2 ?", 370, 790, 220, 84)
d.box("r2",  "prior", "リサンプリング", 660, 807, 230, 50)
d.edge("f11", "wn", "d1")
...
d.box("p5", "prior", "重み付き平均 式(5.4)\n+ 直近数ステップの移動平均で平滑化", 345, 900, 270, 58)
d.box("o1", "data",  "その1歩の推定位置", 345, 985, 270, 46)
